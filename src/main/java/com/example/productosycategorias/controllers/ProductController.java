...
public class ProductController {
	...
	public String mostrarCategories(@PathVariable("idCategories")Long idCategories, @ModelAttribute("enlace") ProductosCategorias productosCategorias, Model model){
		Categoria categoria = mainService.getCategoria(idCategories);
		model.addAttribute("categoria", categoria);
		model.addAttribute("productos", mainService.categoriaSinProducto(categoria));
